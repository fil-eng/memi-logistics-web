...
const Profile = () => {
  ...
  const handleSave = async (values) => {
    ...
    try {
      ...
      setStatusMessage("Your shipper profile is up to date.");
    } catch (err) {
  ...
  const navItems = [
    { path: "/shipper/home", label: "Dashboard" },
    { path: "/shipper/active-shipments", label: "Active Shipments" },
  ...
  return (
    <div className={styles.page}>
      <AccountShell
        title="My Account"
        subtitle="Manage your shipper profile and account settings."
        ...
        <div className={styles.card}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>
                {isProfileComplete
                  ? "Update your shipper profile information."
                  : "Complete your shipper profile to create shipments."}
              </p>
            </div>
          </div>
